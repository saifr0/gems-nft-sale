...
export class AllowedTokenUpdated extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save AllowedTokenUpdated entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type AllowedTokenUpdated must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("AllowedTokenUpdated", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): AllowedTokenUpdated | null {
    return changetype<AllowedTokenUpdated | null>(
      store.get_in_block("AllowedTokenUpdated", id.toHexString()),
    );
  }

  static load(id: Bytes): AllowedTokenUpdated | null {
    return changetype<AllowedTokenUpdated | null>(
      store.get("AllowedTokenUpdated", id.toHexString()),
    );
  }
...
export class MinerFundsWalletUpdated extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    ...
    assert(
      id != null,
      "Cannot save MinerFundsWalletUpdated entity without an ID",
    );
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type MinerFundsWalletUpdated must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("MinerFundsWalletUpdated", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): MinerFundsWalletUpdated | null {
    return changetype<MinerFundsWalletUpdated | null>(
      store.get_in_block("MinerFundsWalletUpdated", id.toHexString()),
    );
  }

  static load(id: Bytes): MinerFundsWalletUpdated | null {
    return changetype<MinerFundsWalletUpdated | null>(
      store.get("MinerFundsWalletUpdated", id.toHexString()),
    );
  }
  ...
  get oldMinerFundsWallet(): Bytes {
    let value = this.get("oldMinerFundsWallet");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBytes();
  ...
  set oldMinerFundsWallet(value: Bytes) {
    this.set("oldMinerFundsWallet", Value.fromBytes(value));
  }

  get newMinerFundsWallet(): Bytes {
    let value = this.get("newMinerFundsWallet");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBytes();
  ...
  set newMinerFundsWallet(value: Bytes) {
    this.set("newMinerFundsWallet", Value.fromBytes(value));
  }
...
export class NodeFundsWalletUpdated extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    ...
    assert(
      id != null,
      "Cannot save NodeFundsWalletUpdated entity without an ID",
    );
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type NodeFundsWalletUpdated must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("NodeFundsWalletUpdated", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): NodeFundsWalletUpdated | null {
    return changetype<NodeFundsWalletUpdated | null>(
      store.get_in_block("NodeFundsWalletUpdated", id.toHexString()),
    );
  }

  static load(id: Bytes): NodeFundsWalletUpdated | null {
    return changetype<NodeFundsWalletUpdated | null>(
      store.get("NodeFundsWalletUpdated", id.toHexString()),
    );
  }
  ...
  get oldNodeFundsWallet(): Bytes {
    let value = this.get("oldNodeFundsWallet");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBytes();
  ...
  set oldNodeFundsWallet(value: Bytes) {
    this.set("oldNodeFundsWallet", Value.fromBytes(value));
  }

  get newNodeFundsWallet(): Bytes {
    let value = this.get("newNodeFundsWallet");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBytes();
  ...
  set newNodeFundsWallet(value: Bytes) {
    this.set("newNodeFundsWallet", Value.fromBytes(value));
  }
...
export class PriceAccretionPercentageUpdated extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    ...
    assert(
      id != null,
      "Cannot save PriceAccretionPercentageUpdated entity without an ID",
    );
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type PriceAccretionPercentageUpdated must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set(
  ...
  static loadInBlock(id: Bytes): PriceAccretionPercentageUpdated | null {
    return changetype<PriceAccretionPercentageUpdated | null>(
      store.get_in_block("PriceAccretionPercentageUpdated", id.toHexString()),
    );
  }

  static load(id: Bytes): PriceAccretionPercentageUpdated | null {
    return changetype<PriceAccretionPercentageUpdated | null>(
      store.get("PriceAccretionPercentageUpdated", id.toHexString()),
    );
  }
  ...
  get oldPriceAccretionPercent(): BigInt {
    let value = this.get("oldPriceAccretionPercent");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set oldPriceAccretionPercent(value: BigInt) {
    this.set("oldPriceAccretionPercent", Value.fromBigInt(value));
  }

  get newPriceAccretionPercent(): BigInt {
    let value = this.get("newPriceAccretionPercent");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set newPriceAccretionPercent(value: BigInt) {
    this.set("newPriceAccretionPercent", Value.fromBigInt(value));
  }
...
export class LeaderToToken extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save LeaderToToken entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type LeaderToToken must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("LeaderToToken", id.toString(), this);
    }
  }

  static loadInBlock(id: string): LeaderToToken | null {
    return changetype<LeaderToToken | null>(
      store.get_in_block("LeaderToToken", id),
    );
  }

  static load(id: string): LeaderToToken | null {
    return changetype<LeaderToToken | null>(store.get("LeaderToToken", id));
  }
...
export class ClaimSet extends Entity {
  ...
  get claimInfo_token(): Bytes {
    let value = this.get("claimInfo_token");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBytes();
  ...
  set claimInfo_token(value: Bytes) {
    this.set("claimInfo_token", Value.fromBytes(value));
  }

  get claimInfo_amount(): BigInt {
    let value = this.get("claimInfo_amount");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBigInt();
  ...
  set claimInfo_amount(value: BigInt) {
    this.set("claimInfo_amount", Value.fromBigInt(value));
  }
