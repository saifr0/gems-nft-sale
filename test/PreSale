...
contract PreSaleTest is Test {
    ...
    address signer = 0x12eF0F1C99D8FD50fFd37cCd12B09Ef7f1213269;
    ...
    function setUp() public {
        ...
        TokenRegistry.PriceFeedData[]
            memory priceFeeds = new TokenRegistry.PriceFeedData[](4);
        ...
        deal(address(GEMS), user, 100_000_000000 * 1e6);

        uint256[3] memory nodesNFTPrices = [
            uint256(1000000),
            uint256(200),
            uint256(300)
        ];
        ...
        preSale = new PreSale(
            ...
            signer,
            signer,
            IClaims(0x3fC91A3afd70395Cd496C647d5a6CC9D4B2b7FAD),
            IMinerNft(0x3fC91A3afd70395Cd496C647d5a6CC9D4B2b7FAD),
            INodeNft(0x3fC91A3afd70395Cd496C647d5a6CC9D4B2b7FAD),
            owner,
            1000000,
            nodesNFTPrices,
            GEMS,
            ...
            // 0x394D002227f0C0E06d4fA991b646A3d5EE34421D)
        );
    ...
    function testPurchase() external {
        ...
        uint256 quantity = 10;
        console.log("GEMS user baalnce---", GEMS.balanceOf(user));
        console.log("USDT user baalnce---", USDT.balanceOf(user));
