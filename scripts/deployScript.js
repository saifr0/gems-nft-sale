...
async function main() {
    ...
    const minersNFTPriceInit = ['100000000', '200000000', '300000000'];
    ...
    verify('0xC498C812d0b254dac59294E5E498a62C73d92B84', [
        projectWalletAddress,
        platformWalletAddress,
        burnWalletAddress,
        signerAddress,
        ...
        gemsAddress,
        usdtAddress,
        '0x60373DfF89364A57d21a25Fb67fEE2A0Ac75139b',
        '0x4e4153557135c1d61FA8C221D4D5dca0a7f76FBF',
        '0x12fC1F34efE38528bB9960e64D684efbd4f646E8',
        tokenRegistryAddress,
        nodesNFTPriceInit,
        minersNFTPriceInit
    ]);
    ...
    //   // -------------------------------- ProxyFactory------------------------------------------ //
    const ProxyFactory = await hre.ethers.deployContract('ProxyFactory', [tokenRegistryAddress, platformWalletAddress, ownerAddress, signerAddress, feeAmount]);
