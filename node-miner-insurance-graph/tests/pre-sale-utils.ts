...
export function createInsuranceFeeUpdatedEvent(
  oldInsuranceFee: BigInt,
  newInsuranceFee: BigInt
): InsuranceFeeUpdated {
  let insuranceFeeUpdatedEvent = changetype<InsuranceFeeUpdated>(newMockEvent())

  insuranceFeeUpdatedEvent.parameters = new Array()

  insuranceFeeUpdatedEvent.parameters.push(
    new ethereum.EventParam(
      "oldInsuranceFee",
      ethereum.Value.fromUnsignedBigInt(oldInsuranceFee)
    )
  )
  insuranceFeeUpdatedEvent.parameters.push(
    new ethereum.EventParam(
      "newInsuranceFee",
      ethereum.Value.fromUnsignedBigInt(newInsuranceFee)
    )
  )

  return insuranceFeeUpdatedEvent
}
...
export function createMinerFundsWalletUpdatedEvent(
  ...
  let minerFundsWalletUpdatedEvent = changetype<MinerFundsWalletUpdated>(
    newMockEvent()
  )
...
export function createMinerNftPurchasedDiscountedEvent(
  ...
  minerNftPurchasedDiscountedEvent.parameters.push(
    new ethereum.EventParam(
      "discountPercentage",
      ethereum.Value.fromUnsignedBigInt(discountPercentage)
    )
  )
  minerNftPurchasedDiscountedEvent.parameters.push(
    new ethereum.EventParam("isInsured", ethereum.Value.fromBoolean(isInsured))
...
export function createNodeFundsWalletUpdatedEvent(
  ...
  let nodeFundsWalletUpdatedEvent = changetype<NodeFundsWalletUpdated>(
    newMockEvent()
  )
